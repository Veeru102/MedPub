          ...
          {loading ? (
            <div className="flex items-center justify-center py-8">
              <div className="text-center">
                <svg 
                  className="animate-spin h-8 w-8 text-green-600 mx-auto mb-3" 
                  xmlns="http://www.w3.org/2000/svg" 
                  fill="none" 
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-green-700">Finding similar papers...</p>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="text-sm font-medium text-red-800">Unable to find similar papers</h4>
              </div>
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-xs text-gray-400 mt-1">Try uploading a different document</p>
            </div>
          ) : (
            <div className="space-y-4">
              {papers.map((paper, index) => (
                <div 
                  key={paper.id || index} 
                  className="border border-green-200 rounded-lg p-4 hover:shadow-md transition-shadow duration-200 bg-gradient-to-r from-green-50 to-white"
                >
                  ...
                  <div className="text-sm text-gray-600 leading-relaxed mb-3">
                    {paper.abstract ? (
                      ...
                      <span className="italic text-gray-400">No abstract available</span>
                    )}
                  </div>
